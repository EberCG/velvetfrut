...
/* ============ ACCESO (login) ============
   ...
   (con el método "Correo electrónico y contraseña", que debes habilitar
   antes en Authentication → Sign-in method). Ese correo y contraseña son
   los que usarás para entrar a tu panel. */
...
// Solo se activa después de iniciar sesión (ver auth.onAuthStateChanged más abajo).
